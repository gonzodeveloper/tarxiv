...
It follows in the footsteps of the Open Supernova Catalogue ([Github](https://github.com/astrocatalogs/supernovae) - [Guillochon et al. 2017](https://ui.adsabs.harvard.edu/abs/2017ApJ...835...64G/abstract)) and the [AstroCats](https://github.com/astrocatalogs/astrocats) initiative, but with the philosophy that most astronomers do not have time or resources to compile their currated catalogues of events, and that explosive transients such as TDEs and Supernovae should not have segregated search environments. 
